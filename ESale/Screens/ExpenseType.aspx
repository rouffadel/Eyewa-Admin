<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="ExpenseType.aspx.cs" Inherits="Screens_Expense" Title="Expense Type" %>
                ...
                <div class="col-md-12">
                    <form class="form-horizontal">
                        <div class="panel panel-default">
                            ...
                            <div id="panelSearchExpense" runat="server" class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox ID="txtSearchExpense" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <br />
                                <div id="panelGridExpense" runat="server">
                                    <div id="gridClass" class="table-responsive"> 
                                        <asp:GridView ID="GridViewExpense" runat="server" AutoGenerateColumns="false"
                                            DataKeyNames="ExpenseTypeID" OnRowCommand="GridViewExpense_RowCommand"
                                            OnRowCreated="GridViewExpense_RowCreated" CssClass="table datatable table-bordered table-striped table-actions"
                                            OnRowDeleting="GridViewExpense_RowDeleting" OnRowEditing="GridViewExpense_RowEditing">
                                            <Columns>
                                                <asp:BoundField ItemStyle-CssClass="middle" ItemStyle-Width="30"
                                                    DataField="ExpenseType" HeaderText="Expense Type"></asp:BoundField>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="90">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:ImageButton ID="lnkbtnEdit" runat="server" Text="Edit" CommandArgument='<%#((GridViewRow)Container).RowIndex %>'
                                                            CommandName="Edit" ImageUrl="../images/pencil.png" ValidationGroup="False" Style="width: 16px">
                                                        </asp:ImageButton>
                                                        <asp:ImageButton ID="lnkbtnDel" runat="server" Text="Delete" CommandArgument='<%#((GridViewRow)Container).RowIndex %>'
                                                            CommandName="Delete" ImageUrl="../images/cross.png" ValidationGroup="False" Style="width: 16px"
                                                        ...
                                                        <asp:LinkButton ID="lnkbtnView" runat="server" CommandArgument='<%#((GridViewRow)Container).RowIndex%>'
                                                            ...
                                                            Style="text-decoration: none;" CssClass="fav fa-eye" ToolTip="View">
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="lnkbtnEdit" runat="server" CommandName="EditRow" CommandArgument='<%#((GridViewRow)Container).RowIndex%>'
                                                            Style="text-decoration: none;" CssClass="fae fa-pencil" ToolTip="Edit" ValidationGroup="False">
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="lnkbtnDel" CommandArgument='<%#((GridViewRow)Container).RowIndex%>'
                                                            ...
                                                            CommandName="Delete"  runat="server" ToolTip="Delete"
                            ...
                            <div id="panelAddExpense" runat="server" class="page-content-wrap">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">
                                                Store</label>
                                            <div class="col-md-8">
                                                <asp:DropDownList ID="ddladdStore" runat="server"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox CssClass="form-control" ID="txtAddExpense" runat="server" onkeyup="datevalidation(this);" />
                                                </div>
                                                <asp:RequiredFieldValidator ID="rfvAddExpense" runat="server" ValidationGroup="r"
                                                    ControlToValidate="txtAddExpense" Text="*" ErrorMessage="Expense Type Cannot be Empty">
                            ...
                            <div class="panel-footer" id="dvFooter" runat="server">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2" id="dvisave" runat="server">
                                        <asp:Button ID="imgAddExpense" ValidationGroup="r" runat="server" CssClass="btn btn-success btn-block pull-right"
                                            Text="Save" Style="margin-bottom: 5px;" CausesValidation="true" OnClientClick="this.disabled = true;" 
                                             
                                            OnClick="imgExpense_Click" />
                                    </div>
                                    <div class="col-md-2" id="dvupdate" runat="server">
                                        <asp:Button ID="imgUpdateExpense" ValidationGroup="r" Visible="false" runat="server"
                                    ...
                                    <div class="col-md-2" id="dvclear" runat="server">
                                        <asp:Button ID="imgClearExpense" runat="server" CssClass="btn btn-warning btn-block pull-left"

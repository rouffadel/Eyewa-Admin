<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="Store.aspx.cs" Inherits="Screens_Store" Title="Store" %>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox ID="txtStoreNameSearch" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-search"></span></span>
                                                        <asp:TextBox ID="txtContactNumberSearch" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="pnlSearchGrid" runat="server" class="row top">
                                        <div id="gridClass" class="table-responsive">
                                            <asp:GridView ID="gvStore" runat="server" AutoGenerateColumns="false"
                                                ...
                                                OnRowEditing="gvStore_RowEditing" OnRowDeleting="gvStore_RowDeleting" OnRowCreated="gvStore_RowCreated"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="StoreName" HeaderText="Store Name" ItemStyle-CssClass="middle"
                                                        ItemStyle-Width="30" />
                                                    <asp:BoundField DataField="StoreCode" HeaderText="Store Code" ItemStyle-CssClass="middle"
                                                        ItemStyle-Width="30" />
                                                    <asp:BoundField DataField="Address" HeaderText="Address" ItemStyle-CssClass="middle"
                                                        ItemStyle-Width="30" />
                                                    <asp:BoundField DataField="City" HeaderText="City" ItemStyle-CssClass="middle" ItemStyle-Width="30" />
                                                    <asp:BoundField DataField="ZipCode" HeaderText="ZipCode" ItemStyle-CssClass="middle"
                                                        ItemStyle-Width="30" />
                                                    <asp:BoundField DataField="ContactPerson" HeaderText="Contact Person" ItemStyle-CssClass="middle"
                                                        ItemStyle-Width="30" />
                                                    <asp:BoundField DataField="ContactNumber" HeaderText="Contact Number" ItemStyle-CssClass="middle"
                                                        ItemStyle-Width="30" />
                                                    <asp:BoundField DataField="EmailID" HeaderText="EmailID" ItemStyle-CssClass="middle"
                                                        ItemStyle-Width="30" />
                                                    <asp:TemplateField ItemStyle-ForeColor="Gray" ItemStyle-CssClass="middle" ItemStyle-Width="90"
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ValidationGroup="r" ID="RequiredFieldValidator1" runat="server"
                                                ControlToValidate="DDLOrganisation"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox CssClass="form-control" ID="txtStoreName" runat="server" />
                                                </div>
                                                ...
                                                <asp:RequiredFieldValidator ValidationGroup="r" ID="RequiredFieldValidator3" runat="server"
                                                    ...
                                                    ErrorMessage="Please Insert Store Name" Text="*"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                    <asp:TextBox CssClass="form-control" ID="txtStoreCode" runat="server" />
                                                </div>
                                                <asp:RequiredFieldValidator ValidationGroup="r" ID="RequiredFieldValidator2" runat="server"
                                                    ...
                                                    ErrorMessage="Please Insert Store Code" Text="*"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                    <asp:TextBox ID="txtEmailID" runat="server" CssClass="form-control" onchange="return CheckMail(this);"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row top">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <%--  <div class="input-group">--%>
                                                <asp:Image ID="imgStore" runat="server" Style="height: 100px; width: 100px;" />
                                    ...
                                    <div class="col-md-2" id="dvisave" runat="server">
                                        <asp:Button ID="imgSave" ValidationGroup="r" runat="server" CssClass="btn btn-success btn-block pull-right"
                                            Text="Save" Style="margin-bottom: 5px;" CausesValidation="true" OnClientClick="this.disabled = true;" 
                                             UseSubmitBehavior="false" OnClick="imgSave_Click" />

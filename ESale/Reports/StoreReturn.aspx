<%@ Page Title="Store Return" Language="C#" MasterPageFile="~/Admin/Admin.master"
    AutoEventWireup="true" CodeFile="StoreReturn.aspx.cs" Inherits="Reports_StoreReturn" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <%--<asp:ToolkitScriptManager ID="tsm" runat="server"> </asp:ToolkitScriptManager>--%>

    <asp:Label ID="lblTitle" Text="Store Return Report" runat="server" Visible="false"
        CssClass="TitleClass"></asp:Label>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <strong>Store Return Report</strong>
                                </h3>
                            </div>
                            <center>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <asp:TextBox CssClass="form-control" ID="txtStoreDeliveryNoteNo" runat="server" Enabled="false" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
               ...
               <br />
                            <div id="pnlGrid" runat="server">
                              <div class="table-responsive">
                                    ...
                                    CssClass="table datatable table-bordered table-striped table-actions"
                                        HorizontalAlign="Center" OnRowDataBound="gvStock_RowDataBound" DataKeyNames="StoreReturnId"
                                        ...
                                        <Columns>
                                         ...
                                         <%--   <asp:BoundField DataField="StoreName" HeaderText="Store Name" />--%>
                                          <asp:TemplateField HeaderText="Store Name"  ItemStyle-CssClass="middle" ItemStyle-Width="30">
                                            ...
                                            <asp:BoundField DataField="ReturnNumber" HeaderText="Return No" ItemStyle-CssClass="middle" ItemStyle-Width="30" />
                                            <asp:TemplateField HeaderText="Return Date" ItemStyle-CssClass="middle" ItemStyle-Width="30">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblStoreDeliveryNoteDate" runat="server" Text='<%#Bind("ReturnDate") %>'></asp:Label>
                                                </ItemTemplate>
                                               <%-- <FooterTemplate>
                                                    <asp:Label ID="lbltotal" runat="server" Text="Total"></asp:Label>
                                                </FooterTemplate>--%>
                                            ...
                                            <asp:TemplateField HeaderText="Quantity" ItemStyle-CssClass="middle" ItemStyle-Width="30" >
                                                <ItemTemplate>
                                                    <asp:Label ID="lblQuantity" runat="server" Text='<%# Bind("TotalQty") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Selling Price" ItemStyle-CssClass="middle" ItemStyle-Width="30">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSellingprice" runat="server" Text='<%# Bind("TotalSellingPrice") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                       CssClass="table datatable table-bordered table-striped table-actions"
                                        ...
                                        <Columns>
                                            ...
                                            <%--<asp:BoundField DataField="StoreName" HeaderText="Store Name" />--%>
                                            <asp:BoundField DataField="ReturnNumber" HeaderText="Return No" ItemStyle-CssClass="middle" ItemStyle-Width="30" />
                                            <asp:BoundField DataField="ReturnDate" HeaderText="Return Date" ItemStyle-CssClass="middle" ItemStyle-Width="30" />
                    ...
                    <div class="modal-content" id="printdiv">
                        <div class="modal-header">
                                ...
                                <center>
                                <h2 class="modal-title">Store Return
                                </h2>
                            </center>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6" style="width:35%;float:left;margin-left:15%;">
                                                        ...
                                                        <div class="row">
                                                           <%-- <div class="row">
                                                                <div class="form-group">--%>
                                                                    <label id="Label2" class="Label pull-left">Return Date:</label>
                                                                   <%-- <div class="row">
                                                                        <div class="input-group">--%>

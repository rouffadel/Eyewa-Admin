...
public partial class Reports_Sales : System.Web.UI.Page
{
   ...
   // int salescount = 0, saleidcount = 0;
    ...
    [WebMethod]
    public static GridDataSet SalesPrint(string salesid)
    {
    ...
    protected void gvSales_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            //    }
            ((Label)e.Row.FindControl("lblTotalNetTotal")).Text = totinvoiceamount.ToString();
